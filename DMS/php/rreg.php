...
if($act=="save")
{
$sql="select * from ruser where username ='$username'";
$res=mysql_query($sql);
if(!mysql_num_rows($res))
	{
		

		$sql="insert into `ruser` (username,nickname,password,sex,email,qq,tel,dep,addr) values ('$username','$nickname','$password','$sex','$email','$qq','$tel','$dep','$addr')";
$res=mysql_query($sql);
	if($res)
	{
...
<form name="form1" method="post" action="?act=save&id=<?php echo $id?>" enctype="multipart/form-data" onSubmit="return check_uploadObject(this)"><table width="950"  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
 ...
 <tr>
    <td height="19" colspan="4" class="tdtitle"><div align="center" class="title"> 受赠用户注册</div></td>
  </tr>
