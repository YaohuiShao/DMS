...
if($act=="del")
{
	...
	if($result)
	{
		echo "<script>alert('删除成功');location.href='ruser.php';</script>";
		exit;
	}
	else
	{
...
<tr align="center" bgcolor="#F2FDFF"><td class="optiontitle">登录账号</td>
...
<td height="25">
<a href="./memberAdd.php">修改信息</a>|<a href="?act=del&id=<?php echo $data[id]?>" onClick="return confirm('您确定要删除吗?')">删除</a></td>
</tr>
<?php
}
?>
