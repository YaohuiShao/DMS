...
<title>留言板模块</title><body topmargin="0" leftmargin="0" bottommargin="0">
...
$sql="update guest set replay='$replay',rtime=NOW() where id=$id";
$res=mysql_query($sql);
if($res)
	{
...
{
	  ?>
<table width="640" class="table_big" border="1" align="center" cellpadding="0" cellspacing="0">
    ...
    <td height="40" colspan="2" bgcolor="#E7E7E7"><table width="740" class="table_southidc"  border="0" align="center" cellpadding="0" cellspacing="1">
        <tr>
		 ...
		 <?php
			 ...
			 $sql1=mysql_query("select * from guest order by addtime desc ");
...
<p>&nbsp;</p>
  ...
  <table width="740" border="0" align="center" cellpadding="0" cellspacing="0" class="table_big">
    <tr>
