...
if($act=="save")
{
		...
		$sql="update ruser set nickname='$nickname',password='$password',sex='$sex',email='$email',qq='$qq',tel='$tel',dep='$dep',addr='$addr' where id=$_SESSION[user_id]";
$res=mysql_query($sql);
	if($res)
	{
	echo "<script>alert('修改成功');location.href='ruser.php';</script>";
	exit;
	}
	else
	{
